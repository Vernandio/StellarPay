...
export default function WithdrawScreen() {
  ...
  const withdrawDestinations = [
    { id: "bank", title: "Bank Transfer", icon: "briefcase", sub: "1-3 business days (Free)" },
    { id: "apple_pay", title: "Apple Pay", icon: "smartphone", sub: "Instant (1.5% fee)" },
    { id: "card", title: "Debit Card", icon: "credit-card", sub: "Instant (1.5% fee)" },
    { id: "crypto", title: "Crypto Withdrawal", icon: "link", sub: "Via Stellar Network" },
  ];
      ...
      >
        <ScrollView contentContainerStyle={{ paddingBottom: Spacing.xl, flexGrow: 1 }} showsVerticalScrollIndicator={false}>
          ...
          <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: Spacing.lg, paddingVertical: Spacing.md, marginBottom: Spacing.lg }}>
            ...
            <Text style={[Typography.headingLarge, { color: Colors.textLightPrimary, fontWeight: "700", fontSize: 20 }]}>Withdraw</Text>
            <View style={{ width: 40 }} />
          </View>
          ...
          <View style={{ paddingHorizontal: Spacing.lg }}>
            ...
            <View style={{ backgroundColor: Colors.white, borderRadius: 24, paddingHorizontal: Spacing.md, shadowColor: "#000", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.03, shadowRadius: 12, elevation: 2 }}>
              {withdrawDestinations.map((method, index) => {
                ...
                return (
                  <Pressable
                    ...
                    style={{
                      ...
                      borderBottomWidth: index === withdrawDestinations.length - 1 ? 0 : 1,
        ...
        <View style={{ paddingHorizontal: Spacing.lg, paddingBottom: Spacing.md, paddingTop: Spacing.sm }}>
          ...
          >
            <Text style={[Typography.labelLarge, { color: Colors.white, fontWeight: "700", fontSize: 16 }]}>
              {amount && parseFloat(amount) > 0 ? `Withdraw ${currency.symbol}${amount}` : "Enter Amount"}
            </Text>
          </Pressable>
        </View>
      </KeyboardAvoidingView>
